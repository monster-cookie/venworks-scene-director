ScriptName Venworks:DynamicScenesEngine:DSEController Extends Venworks:DynamicScenesEngine:Base:BaseQuest
...
Function LogModuleInformational(String functionName, String logMessage)
  LogUserInformational(moduleName="DSEController", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleWarning(String functionName, String logMessage)
  LogUserWarning(moduleName="DSEController", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleError(String functionName, String logMessage)
  LogUserError(moduleName="DSEController", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleCritical(String functionName, String logMessage)
  LogUserCritical(moduleName="DSEController", functionName=functionName, logMessage=logMessage)
EndFunction
