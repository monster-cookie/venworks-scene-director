ScriptName Venworks:DynamicScenesEngine:Helpers:SQ_DSE_FactionConfiguration Extends Venworks:DynamicScenesEngine:Base:BaseQuest
{
...
Function LogModuleInformational(String functionName, String logMessage)
  LogUserInformational(moduleName="Helpers:SQ_DSE_FactionConfiguration", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleWarning(String functionName, String logMessage)
  LogUserWarning(moduleName="Helpers:SQ_DSE_FactionConfiguration", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleError(String functionName, String logMessage)
  LogUserError(moduleName="Helpers:SQ_DSE_FactionConfiguration", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleCritical(String functionName, String logMessage)
  LogUserCritical(moduleName="Helpers:SQ_DSE_FactionConfiguration", functionName=functionName, logMessage=logMessage)
EndFunction
