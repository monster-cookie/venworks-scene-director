ScriptName Venworks:DynamicScenesEngine:DSETriggerOverlay Extends Venworks:DynamicScenesEngine:Base:BaseObjectReference
{ 
...
Function LogModuleInformational(String functionName, String logMessage)
  LogUserInformational(moduleName="DSETriggerOverlay", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleWarning(String functionName, String logMessage)
  LogUserWarning(moduleName="DSETriggerOverlay", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleError(String functionName, String logMessage)
  LogUserError(moduleName="DSETriggerOverlay", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleCritical(String functionName, String logMessage)
  LogUserCritical(moduleName="DSETriggerOverlay", functionName=functionName, logMessage=logMessage)
EndFunction
