ScriptName Venworks:DynamicScenesEngine:Managers:DSEManager_Base Extends Venworks:DynamicScenesEngine:Base:BaseObjectReference
...
Import Venworks:Core:Utilities:Random
Import Venworks:Core:Utilities:Array
...
Group Autofill
  Venworks:DynamicScenesEngine:Helpers:SQ_DSE_SpawnSystem Property SQ_DSE_SpawnSystem Auto Const Mandatory
  {Handler Script for the DSE Spawner System}

  Venworks:DynamicScenesEngine:Helpers:SQ_DSE_FactionConfiguration Property SQ_DSE_FactionConfiguration Auto Const Mandatory
...
Function LogModuleInformational(String functionName, String logMessage)
  LogUserInformational(moduleName="Managers:DSEManager_Base", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleWarning(String functionName, String logMessage)
  LogUserWarning(moduleName="Managers:DSEManager_Base", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleError(String functionName, String logMessage)
  LogUserError(moduleName="Managers:DSEManager_Base", functionName=functionName, logMessage=logMessage)
EndFunction

Function LogModuleCritical(String functionName, String logMessage)
  LogUserCritical(moduleName="Managers:DSEManager_Base", functionName=functionName, logMessage=logMessage)
EndFunction
